...
\input{sections/parcours}
\include{sections/tutorat}
\include{sections/evaluations_differenciees}
...
\begin{appendices}
	\include{annexes/tableau_differenciation}
    \include{annexes/tetraaide}
    \include{annexes/sujet_differencie}
    \include{annexes/julia}
    \include{annexes/julia_parcours3}
    \include{annexes/xav}
\end{appendices}
\end{document}
