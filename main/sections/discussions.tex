...
Je le referai mais pas dès la rentrée de la 1\up{ère} année ou de manière light. Dès le début de la 2\up{e} année. Plutôt sur séquences de calcul ou constructions géométriques. Forme modifiée, intégrer construction « à la Xavère »\\
...
En dehors de ces retours informels, nous avons eu une grande difficulté à mesurer l'impact de nos expérimentations sur nos élèves. Nadine Grapin nous a suggéré de mettre proposer un questionnaire aux élèves mais nous avons choisi de ne pas le faire. En effet, nous considérons que les élèves ne sont pas assez mûrs pour estimer l'impact de nos mesures sur leur autonomie ou leur acquisition des compétences. +AUTRES PARAMETRES beaucoup de dispositifs dans les écoles + pas assez de temps pour rechercher sur les questions à poser ==> suite
