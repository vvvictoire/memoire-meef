...
\subsubsection*{Premier réel parcours}
...
\subsubsection*{Bilan de l'expérimentation}
...
Après analyse des difficultés de chacun, j'ai mis en place une série de parcours par catégories %\ref{parcours_diff_julia3} :
\begin{itemize}
